...
$this->title = 'All spongebob results (latest)';
...
<table class="table table-bordered table-striped table-sm">
    ...
    <tr>
        ...
        <?php foreach($quizResponses as $quizResponse): ?>
            <th>
                <?= $quizResponse->getSpongebobCount() ?>
            </th>
        <?php endforeach; ?>
    </tr>
    </thead>
    ...
    <?php foreach($quizQuestions as $questionIndex => $quizQuestion): ?>
        <tr>
            ...
            <?php foreach($quizResponses as $quizResponse): ?>
                ...
                <td class="bg-<?= $quizQuestion->isSpongebobQuestion() ? ($givenAnswer->isSpongebob ? 'success' : 'danger') : '' ?>">
